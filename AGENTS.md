...
parity — socketcan and mDNS just work) and the dev signalk-server on
**port 4000**; dev server and browser IDE (:10800) are unauthenticated and
LAN-visible by design. It never touches a production install (production
